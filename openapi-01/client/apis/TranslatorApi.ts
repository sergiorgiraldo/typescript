...
export class TranslatorApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async addTranslator(translator: Translator, _options?: Configuration): Promise<RequestContext> {
        ...
        // Apply auth methods
        authMethod = _config.authMethods["translatorstore_auth"]
     ...
     * @param translator Translstor object
     */
    public async updateTranslator(translator: Translator, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'translator' is not null or undefined
        if (translator === null || translator === undefined) {
            throw new RequiredError("TranslatorApi", "updateTranslator", "translator");
        }
     ...
     */
    public async updateTranslatorWithForm(translatorId: number, name?: string, lang?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'translatorId' is not null or undefined
        if (translatorId === null || translatorId === undefined) {
            throw new RequiredError("TranslatorApi", "updateTranslatorWithForm", "translatorId");
        }
...
export class TranslatorApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateTranslator
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateTranslatorWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Translator >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Translator = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateTranslatorWithForm
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateTranslatorWithFormWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("405", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Invalid input", undefined, response.headers);
        }
